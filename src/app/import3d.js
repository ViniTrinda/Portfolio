...
class ScrollStage {
  constructor() {
    ...
    this.init()
    this.scroll.hard = this.scroll.limit // simula estar no final
    this.scroll.normalized = 0           // 100% da rolagem
    this.updateScrollAnimations()       // aplica os efeitos do "scroll final"
  }
   ...
   */
  addMesh() {
    this.geometry = new THREE.IcosahedronGeometry(1.35, 70)
